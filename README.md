...
5) Migrate data to a SQL data warehouse: Collected data for multiple channels can be migrated from MongoDB to a SQL data warehouse. The SQL Database used here is the "MySQL". Using Python SQL library  "pymysql" to interact with the SQL database.
